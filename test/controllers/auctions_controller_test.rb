...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post auctions_url, params: { auction: { description: @auction.description, expiration_date: @auction.expiration_date, price: @auction.price, starting_price: @auction.starting_price, status: @auction.status, title: @auction.title } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { description: @auction.description, expiration_date: @auction.expiration_date, price: @auction.price, starting_price: @auction.starting_price, status: @auction.status, title: @auction.title } }
